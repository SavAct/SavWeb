...
struct [[ eosio::table, eosio::contract("site")]] static_index_table {
  ...
  vector<Ref>   refs;       // ref[0] contains reffered transaction of the first transaction. If the file is portioned there is a second entry ref[1] with a reference to the last entry  

...
CONTRACT site : public contract{
  ...
  public:
    ...
    */
     ...
     *             refs[2] reference to the first transaction. This entry is optional and only recommended for the last transaction.
    ...
    */
     ...
     * @param scope Scope of the entry
     * @param key Index key of the entry
     * @param refs refs[0] is a reference to last transaction, refs[1] a reference to the old last transaction and refs[2] a reference to the first transaction.
    */
    ...
    */
    ...
    /**
     * Functions without any checking or table entry. They are just to upload a file with a minimum need of CPU and not provided by the current Savact browser
    */
